  ...
  _createClass(UserGuide, [{
    ...
    value: function render() {
      ...
      if (helpIndex === 0 && !acceptedConfirm) {
        return /*#__PURE__*/React.createElement(Fragment, null, children || '', /*#__PURE__*/React.createElement("div", {
        ...
        }, title), /*#__PURE__*/React.createElement("p", null, content), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("button", {
          onClick: this.onSkip
        }, this.getNoText()), /*#__PURE__*/React.createElement("button", {
          onClick: this.acceptConfirm
        }, this.getYesText())))));
      }

      return /*#__PURE__*/React.createElement(HelpText, _extends({}, helpConfig, {
